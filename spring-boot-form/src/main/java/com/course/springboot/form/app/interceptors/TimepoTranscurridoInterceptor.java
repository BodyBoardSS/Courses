...
public class TimepoTranscurridoInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		logger.info("TimepoTranscurridoInterceptor: preHandler() entrando...");
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		logger.info("Timepo Transcurrido: "+tiempoTranscurrido+"milisegundos");
		
		logger.info("TimepoTranscurridoInterceptor: preHandler() saliendo...");
